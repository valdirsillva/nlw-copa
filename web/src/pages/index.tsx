...
import usersAvataresExampleImg from '../assets/users-avatares.png'
...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert('Bolão criado com sucesso. O codigo foi copiado para área de transferência')

      setPoolTitle('')

    } catch (err) {
      console.log('Falha ao criar o bolão', err)
    }
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      ...
      <Image
        src={appPreviewImage}
        alt="Dois celulares mostrando uma prévia do app"
        quality={100}
      />
    </div>
  )
